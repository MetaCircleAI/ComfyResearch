"""pairwise_rbf_layer — ModelDef-channel thin definition.
...
DEF = model_def(
    ModelDef(
        type="pairwise_rbf_layer",
        label='Pairwise RBF layer',
        family=None,
        fields=(
            IntField(key="inFeatures", label='In Features', default=18, min=1),
            IntField(key="outFeatures", label='Out Features', default=48, min=1),
