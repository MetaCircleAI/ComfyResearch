"""afno_patch_embed_layer — ModelDef-channel thin definition.
...
DEF = model_def(
    ModelDef(
        ...
        frontend=FrontendSpec(component_key="AfnoAtomicLayerNode", codegen_key="afno_patch_embed_layer"),
    )
)
