"""rwkv_time_mix_token_model — ModelDef-channel definition + builder provider.
...
DEF = model_def(
    ModelDef(
        type="rwkv_time_mix_token_model",
        ...
        frontend=FrontendSpec(component_key="AlternativeArchTokenLmNode", codegen_key="rwkv_time_mix_token_model"),
    )
)
...
def build(data, context):
    from comfy_research.engine.models.model_builders import _build_rwkv_time_mix_token_model

    return _build_rwkv_time_mix_token_model(data, context)
