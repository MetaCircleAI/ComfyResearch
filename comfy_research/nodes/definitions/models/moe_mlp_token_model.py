"""moe_mlp_token_model — ModelDef-channel definition + builder provider.
...
DEF = model_def(
    ModelDef(
        ...
        frontend=FrontendSpec(component_key="MlpTokenModelNode", codegen_key="moe_mlp_token_model"),
    )
)
...
def build(data, context):
    from comfy_research.engine.models.model_builders import _build_moe_mlp_token_model

    return _build_moe_mlp_token_model(data, context)
