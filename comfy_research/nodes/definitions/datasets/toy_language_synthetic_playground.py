"""synthetic_playground_dataset — NodeDef-channel definition + preview.
...
DEF = dataset_def(
    DatasetDef(
        type="synthetic_playground_dataset",
        ...
        fields=(
            ...
            EnumField(key="playgroundFamily", label="Playground Family", default="depo"),
            IntField(key="depoWindow", label="Depo Window", default=4, min=2),
            IntField(key="manoModulus", label="Mano Modulus", default=17, min=2),
            IntField(key="lanoNestingDepth", label="Lano Nesting Depth", default=4, min=2),
        ),
        frontend=FrontendSpec(component_key="ToyLanguageLmDatasetNode", codegen_key="synthetic_playground_dataset"),
    )
)
