"""multi_hop_fact_chain_dataset — NodeDef-channel definition + preview.
...
DEF = dataset_def(
    DatasetDef(
        type="multi_hop_fact_chain_dataset",
        ...
        fields=(
            IntField(key="vocabSize", label="Vocab Size", default=96, min=2),
            ...
            IntField(key="chainHops", label="Chain Hops", default=3, min=1),
        ),
        frontend=FrontendSpec(component_key="ToyLanguageLmDatasetNode", codegen_key="multi_hop_fact_chain_dataset"),
    )
)
