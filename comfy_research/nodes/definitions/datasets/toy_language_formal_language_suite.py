"""formal_language_suite_dataset — NodeDef-channel definition + preview.
...
DEF = dataset_def(
    DatasetDef(
        type="formal_language_suite_dataset",
        ...
        fields=(
            IntField(key="vocabSize", label="Vocab Size", default=8, min=2),
            ...
            EnumField(key="languageType", label="Language Type", default="anbn", options=('anbn', 'anbncn', 'palindrome', 'parity')),
        ),
        frontend=FrontendSpec(component_key="ToyLanguageLmDatasetNode", codegen_key="formal_language_suite_dataset"),
    )
)
