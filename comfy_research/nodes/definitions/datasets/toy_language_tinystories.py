"""tinystories_dataset — NodeDef-channel definition + preview.
...
DEF = dataset_def(
    DatasetDef(
        ...
        fields=(
            ...
            IntField(key="contextLength", label="Context Length", default=64, min=1),
            ...
            IntField(key="seqLen", label="Seq Len", default=512),
            IntField(key="stride", label="Stride", default=64, min=1),
        ),
        frontend=FrontendSpec(component_key="ToyLanguageLmDatasetNode", codegen_key="tinystories_dataset"),
    )
)
