"""ngram_language_dataset — NodeDef-channel definition + preview.
...
DEF = dataset_def(
    DatasetDef(
        ...
        fields=(
            ...
            IntField(key="orderN", label="Order N", default=3, min=2),
            FloatField(key="dirichletAlpha", label="Dirichlet Alpha", default=1, min=0.001),
        ),
        frontend=FrontendSpec(component_key="ToyLanguageLmDatasetNode", codegen_key="ngram_language_dataset"),
    )
)
